...
function preloader() {
	...
	const isPreloaded = localStorage.getItem(location.href) && document.querySelector('[data-att-preloader="true"]')
	if (preloaderImages.length && !isPreloaded) {
		...
		htmlDocument.setAttribute('data-att-preloader-loading', '')
		htmlDocument.setAttribute('data-att-scrolllock', '')
		...
		document.querySelector('[data-att-preloader="true"]') ? preloaderOnce() : null
	} else {
		addLoadedClass()
	}
	function addLoadedClass() {
		htmlDocument.setAttribute('data-att-preloader-loaded', '')
		htmlDocument.removeAttribute('data-att-preloader-loading')
		htmlDocument.removeAttribute('data-att-scrolllock')
	}
}
