...
// Р‘Р°Р·РѕРІС– СЃС‚РёР»С–
import "./cursor.scss"

export function customCursor() {
	const wrapper = document.querySelector('[data-att-cursor]')
	if (wrapper && !isMobile.any()) {
		const isShadowTrue = document.querySelector('[data-att-cursor-shadow]')
		// РЎС‚РІРѕСЂСЋС”РјРѕ С‚Р° РґРѕРґР°С”РјРѕ РѕР±'С”РєС‚ РєСѓСЂСЃРѕСЂСѓ
...
document.querySelector('[data-att-cursor]') ?
