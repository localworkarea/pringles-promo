...
/*
const galleries = document.querySelectorAll('[data-att-gallery]');
if (galleries.length) {
...
function initGallery() {
	if (document.querySelector('[data-att-gallery]')) {
		const gallery = new lightGallery(document.querySelector('[data-att-gallery]'), {
			//plugins: [lgZoom, lgThumbnail],
			licenseKey: KEY,
			selector: 'a',
			speed: 500,
