...
class Popup {
	constructor(options) {
		let config = {
			...
			init: true,
			//Для кнопок
			attributeOpenButton: 'data-att-popup-link', // Атрибут для кнопки, яка викликає попап
			attributeCloseButton: 'data-att-popup-close', // Атрибут для кнопки, що закриває попап
			// Для сторонніх об'єктів
			fixElementSelector: '[data-att-lp]', // Атрибут для елементів із лівим паддингом (які fixed)
			// Для об'єкту попапа
			attributeMain: 'data-att-popup',
			youtubeAttribute: 'data-att-popup-youtube', // Атрибут для коду youtube
			youtubePlaceAttribute: 'data-att-popup-youtube-place', // Атрибут для вставки ролика youtube
			...
			classes: {
				...
				popupActive: 'data-att-popup-active', // Додається для попапа, коли він відкривається
				bodyActive: 'data-att-popup-open', // Додається для боді, коли попап відкритий
			},
			...
			if (this.targetOpen.element) {
				...
				if (codeVideo) {
					...
					if (!this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttribute}]`)) {
						this.targetOpen.element.querySelector('[data-att-popup-content]').setAttribute(`${this.options.youtubePlaceAttribute}`, '')
					}
...
// Запускаємо
document.querySelector('[data-att-popup]') ?
