...
export let formValidate = {
	...
	removeError(formRequiredItem) {
		...
		if (formRequiredItem.parentElement.querySelector('[data-att-form-error]')) {
			formRequiredItem.parentElement.removeChild(formRequiredItem.parentElement.querySelector('[data-att-form-error]'));
		}
	},
